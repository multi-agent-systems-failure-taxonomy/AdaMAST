"""Claude Code facade for the shared localhost taxonomy picker transport."""
...
PICKER_DIR = ".adamast-claude-picker"
WORKER_MODULE = "adamast.hosts.claude_code.browser_picker"
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="AdaMAST Claude Code browser picker")
