...
- [adamast/hosts/interactive/README.md](adamast/hosts/interactive/README.md) — shared selectors, routes, jobs, and receipts
- [adamast/hosts/claude_code/README.md](adamast/hosts/claude_code/README.md) — Claude Code adapter
- [adamast/hosts/codex/README.md](adamast/hosts/codex/README.md) — Codex adapter
